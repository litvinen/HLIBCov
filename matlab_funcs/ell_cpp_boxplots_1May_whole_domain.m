...
ell2000=load('~/hlibpro-2.6/examples/111res_ell_WHOLE_DOMAIN_2K_30April.txt', '-ascii');
ell4000=load('~/hlibpro-2.6/examples/111res_ell_WHOLE_DOMAIN_4K_30April.txt', '-ascii');
ell8000=load('~/hlibpro-2.6/examples/111res_ell_WHOLE_DOMAIN_8K_30April.txt', '-ascii');
ell16000=load('~/hlibpro-2.6/examples/111res_ell_WHOLE_DOMAIN_16K_30April.txt', '-ascii');
ell32000=load('~/hlibpro-2.6/examples/111res_ell_WHOLE_DOMAIN_32K_30April.txt', '-ascii');
ell64000=load('~/hlibpro-2.6/examples/111res_ell_WHOLE_DOMAIN_64_30April.txt', '-ascii');
ell128000=load('~/hlibpro-2.6/examples/111res_ell_WHOLE_DOMAIN_2K_30April.txt', '-ascii');
ell256000=load('~/hlibpro-2.6/examples/111res_ell_WHOLE_DOMAIN_2K_30April.txt', '-ascii');
...
save_figure(gcf, '20April_box_plots_sigma2_N_whole', 'figdir', '.', 'fontsize', 18 )
figure
