...
ell2000=load('~/hlibpro-2.6/examples/Results_with_scaledMatern/111res_ell_WHOLE_DOMAIN_2K_19April.txt', '-ascii');
ell4000=load('~/hlibpro-2.6/examples/Results_with_scaledMatern/111res_ell_WHOLE_DOMAIN_4K_19April.txt', '-ascii');
ell8000=load('~/hlibpro-2.6/examples/Results_with_scaledMatern/111res_ell_WHOLE_DOMAIN_8K_19April.txt', '-ascii');
ell16000=load('~/hlibpro-2.6/examples/Results_with_scaledMatern/111res_ell_WHOLE_DOMAIN_16K_19April.txt', '-ascii');
ell32000=load('~/hlibpro-2.6/examples/Results_with_scaledMatern/111res_ell_WHOLE_DOMAIN_32K_19April.txt', '-ascii');
ell64000=load('~/hlibpro-2.6/examples/Results_with_scaledMatern/111res_ell_WHOLE_DOMAIN_64K_19April.txt', '-ascii');
ell128000=load('~/hlibpro-2.6/examples/Results_with_scaledMatern/111res_ell_WHOLE_DOMAIN_128K_19April.txt', '-ascii');
ell256000=load('~/hlibpro-2.6/examples/Results_with_scaledMatern/111res_ell_WHOLE_DOMAIN_256K_20April.txt', '-ascii');
...
boxplot([ell32(1:50) ell16(1:50) ell8(1:50) ell4(1:50) ell2(1:50)],'notch','on','labels',{'32K','16K','8K', '4K', '2K'})
figure
