...
mydata=load('/home/litvina/hlibpro-2.6/examples/111logli_nu_7June2017.txt', '-ascii');
...
%xlim([0.05 0.2]);
hold on;
ylabel('$-\tilde{\mathcal{L}}/n$','Interpreter','latex');
xlabel('$\nu$','Interpreter','latex');
legend('2000', '4000', '8000', '16000', '32000', '64000', '128000')
set(gca,'FontSize',16);
save_figure(gcf, 'logli_nu_23July2017_loglog', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figs/', 'fontsize', 18)
...
legend('2000', '4000', '8000', '16000', '32000', '64000', '128000')
set(gca,'FontSize',16);
save_figure(gcf, 'logli_nu_23July2017_plot', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figs/', 'fontsize', 18)
