function output = my_errorbox_18Aug18_vs_eps_50(datafile, flag, flag2)
...
if(flag==0)
    ...
    ell=dd(:, 7); %ell
    sigma2=dd(:, 8); %sigma2
    coeff = sigma2./power(ell,2*nu);
    semilogx(eps0, coeff, 'color', [0.0 0.6 0], 'LineWidth',2)
    hold on
    output = [eps0, coeff] ;
else
    ell2=dd(:,flag);
    semilogx(eps0, ell2, 'color', [0.0 0.6 0], 'LineWidth',2)
    hold on
    output = [eps0, ell2] ;
end
end
