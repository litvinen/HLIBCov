function my_errorbox_compute_fixedk(datafile, k)
...
%grp = [128000*ones(1,Nell128) 64000*ones(1,Nell64), 32000*ones(1,Nell32), 16000*ones(1,Nell16), 8000*ones(1,Nell8),4000*ones(1,Nell4), 2000*ones(1,Nell2)];
%C = [ell64' ell32' ell16' ell8' ell4' ell2'];
...
save_figure(gcf, 'May1_ell_fK8', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
...
xlabel('$n$, samples in thousands','Interpreter','latex');
ylabel('$\nu$','Interpreter','latex');
save_figure(gcf, 'May1_nu_fK8', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
...
save_figure(gcf, 'May1_sigma_fK8', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
...
save_figure(gcf, 'May1_coeff_fK8', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
