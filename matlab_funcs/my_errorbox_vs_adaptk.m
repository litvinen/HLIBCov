% 1May 2018
function my_errorbox_vs_adaptk(datafile, n)
...
xlabel('$k$, max. rank','Interpreter','latex');
%xlabel('$n$, samples in thousands','Interpreter','latex');
ylabel('$\ell$','Interpreter','latex');
%save_figure(gcf, 'May1_ell_vs_adarank_16K', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
