...
%  xlim([0.9*1e-6 5*1e-3]);
  ...
  save_figure(gcf, '12Sept2018_graphs_nu_64K', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
end
if(flag==7)
 ...
 %  xlim([1e-8, 1e-4]);
  ...
  % xticks([10^-8 10^-7 10^-6 10^-5 10^-4])
  % xticklabels({'10^{-7}','10^{-6}','10^{-5}','10^{-4}'})
  save_figure(gcf, '12Sept2018_graphs_ell_64K', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
end
if(flag==8)
 ...
 % xlim([0.9*1e-6 5*1e-3]);
  ...
  save_figure(gcf, '12Sept2018_graphs_sigma2_64K', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
end
