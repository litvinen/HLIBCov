...
d2000=load('~/hlibpro-2.6/examples/111synt_30May_2K.txt', '-ascii');
d4000=load('~/hlibpro-2.6/examples/111synt_30May_4K.txt', '-ascii');
d8000=load('~/hlibpro-2.6/examples/111synt_30May_8K.txt', '-ascii');
d16000=load('~/hlibpro-2.6/examples/111synt_30May_16K.txt', '-ascii');
d32000=load('~/hlibpro-2.6/examples/111synt_30May_32K.txt', '-ascii');
d64000=load('~/hlibpro-2.6/examples/111synt_30May_64K.txt', '-ascii');
d128000=load('~/hlibpro-2.6/examples/111synt_30May_64K.txt', '-ascii');
truth_ell=0.08746;
truth_nu=0.5;
truth_sigma=1.0;
...
%save_figure(gcf, '27May_box_plots_ell_synthetic', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
