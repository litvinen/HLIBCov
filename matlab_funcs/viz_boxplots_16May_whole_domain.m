...
d2000=load('~/hlibpro-2.6/examples/c/15May_synthetic_2K.txt', '-ascii');
d4000=load('~/hlibpro-2.6/examples/c/15May_synthetic_4K.txt', '-ascii');
d8000=load('~/hlibpro-2.6/examples/c/15May_synthetic_8K.txt', '-ascii');
d16000=load('~/hlibpro-2.6/examples/c/15May_synthetic_16K.txt', '-ascii');
d32000=load('~/hlibpro-2.6/examples/c/15May_synthetic_32K.txt', '-ascii');
d64000=load('~/hlibpro-2.6/examples/c/15May_synthetic_64K.txt', '-ascii');
d128000=load('~/hlibpro-2.6/examples/c/15May_synthetic_128K.txt', '-ascii');
truth_ell=0.08646;
truth_nu=0.5;
truth_sigma=1.0;
...
save_figure(gcf, '15May_box_plots_ell_synthetic', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
%save_figure(gcf, '15May_box_plots_nu_synthetic', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
%save_figure(gcf, '15May_box_plots_sigma2_synthetic', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
