...
%flag=7; % \ell=0.7
flag=9; % \sigma=1.0
   datafile=strcat('~/hlibpro-2.6.1/examples/results/111_5Mai2018_vs_eps_1.txt');
...
grp = [64000*ones(1,Nell64), 32000*ones(1,Nell32), 16000*ones(1,Nell16), 8000*ones(1,Nell8),4000*ones(1,Nell4)];
...
boxplot(C, grp, 'grouporder',{ '64000', '32000', '16000', '8000', '4000'},'labels',{'64','32','16','8','4'});
...
grp = [64000*ones(1,Nell64), 32000*ones(1,Nell32), 16000*ones(1,Nell16), 8000*ones(1,Nell8),4000*ones(1,Nell4)];
%C = [sigma128' sigma64' sigma32' sigma16' sigma8' sigma4' sigma2'];
C = [sigma64' sigma32' sigma16' sigma8' sigma4'];
%boxplot(C, grp, 'grouporder',{'128000', '64000', '32000', '16000', '8000', '4000', '2000'},'labels',{'128', '64','32','16','8','4','2'});
boxplot(C, grp, 'grouporder',{'64000', '32000', '16000', '8000', '4000'},'labels',{'64','32','16','8','4'});
x=0:1:8;
...
grp = [ 64000*ones(1,Nell64), 32000*ones(1,Nell32), 16000*ones(1,Nell16), 8000*ones(1,Nell8),4000*ones(1,Nell4)];
%C = [coeff128' coeff64' coeff32' coeff16' coeff8' coeff4' coeff2'];
C = [ coeff64' coeff32' coeff16' coeff8' coeff4'];
%boxplot(C, grp, 'grouporder',{'128000', '64000', '32000', '16000', '8000', '4000', '2000'},'labels',{'128','64','32','16','8','4','2'});
boxplot(C, grp, 'grouporder',{'64000', '32000', '16000', '8000', '4000'},'labels',{'64','32','16','8','4'});
xlabel('$n$, samples in thousands','Interpreter','latex');
