...
for jj=1:10
   ...
   output = my_errorbox_18Aug18_vs_eps_50(datafile, flag, flag2);
   eps=output(:,1)
   if(jj==1)
       all_values = output(:,2)
   else    
...
if(flag==6)
  ...
  %save_figure(gcf, '18Aug2018_graphs_nu_4K_scaled3', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
end
if(flag==7)
  ylabel('$\hat{\ell}$','Interpreter','latex');
  ylim([0.6 0.9]);
  xlim([0.9*1e-6 5*1e-3]);
  %save_figure(gcf, '18Aug2018_graphs_ell_4K_scaled3', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
end
if(flag==8)
  ...
  %save_figure(gcf, '18Aug2018_graphs_sigma2_4K_scaled3', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
end
