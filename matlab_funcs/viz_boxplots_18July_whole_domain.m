...
%nu32=approx32000(:,1);
n=Nell2;
coeff2=sigma2(1:n)./power(ell4(1:n), 2*sigma4(1:n));
n=Nell4;
...
%save_figure(gcf, '27May_box_plots_ell_N_whole', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
%save_figure(gcf, '27May_box_plots_nu_N_whole', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
%save_figure(gcf, '27May_box_plots_sigma2_N_whole', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
%save_figure(gcf, '27May_box_plots_coeff_N_whole', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
