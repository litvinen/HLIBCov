...
d=load('~/hlibpro-2.6.1/examples/111res_29April2018_par3d_1e-8.txt', '-ascii');
index0=(d(:,2)==2000);
d2000=d(index0,:);
index0=(d(:,2)==4000);
d4000=d(index0,:);
...
save_figure(gcf, '29April_box_plots_ell', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
...
xlabel('$n$, samples in thousands','Interpreter','latex');
ylabel('$\nu$','Interpreter','latex');
save_figure(gcf, '29April_box_plots_nu', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
...
save_figure(gcf, '29April_box_plots_sigma2', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
...
save_figure(gcf, '29April_box_plots_coeff', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsApril2018/', 'fontsize', 18 )
