...
d128000t=load('~/hlibpro-2.6/examples/c/3May_128K.txt', '-ascii');

d128000t=sort(d128000t,4);
%d128000t=d128000t(1:60,:);
ind=find(0.9<d128000t(:,4) & d128000t(:,4)<1.55);
d128000=d128000t(ind,:);
...
%save_figure(gcf, '27May_box_plots_ell_N_whole_c', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
%save_figure(gcf, '27May_box_plots_nu_N_whole_c', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
save_figure(gcf, '27May_box_plots_sigma2_N_whole_c', 'figdir', '/home/litvina/Dropbox/111Hcov_paper/figsMay2017/', 'fontsize', 18 )
